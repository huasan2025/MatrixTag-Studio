...
Example output generated by `DMLabelTool`:

![DMLabelTool sample output](assets/readme/FD40000035.png)

Label spec:
- Trim size: `40 mm (W) x 30 mm (H)`
- Bleed: `1.5 mm` total (`0.75 mm` each side)
- DPI: `300`
